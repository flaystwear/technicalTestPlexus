...
public class AssetService {
    ...
    public AssetConsultingResponse upload(String filename, String contentType, byte[] encodedFile) {
        // Aquí podríamos almacenar el archivo y construir la URL; por ahora, simulamos
        AssetConsultingResponse asset = new AssetConsultingResponse();
        ...
        asset.setUploadDate(OffsetDateTime.now().toString());
        return assetRepository.save(asset);
    }

    public List<AssetConsultingResponse> search(String uploadDateStart, String uploadDateEnd, String filename, String filetype, String sortDirection) {
